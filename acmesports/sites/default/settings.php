 ...
 ***************************/
  ...
  // Include settings.local.php if hosted not on Pantheon (just in case I decide to host the site on pantheon for a live/hands demo).
 if ((file_exists($app_root . '/' . $site_path . '/settings.local.php')) && !defined('PANTHEON_ENVIRONMENT')) {
